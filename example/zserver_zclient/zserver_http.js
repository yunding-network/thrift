var DDingThrift = require('../../index'),
	ZHttpServer = DDingThrift.ZHttpServer,
	Zookeeper = DDingThrift.Zookeeper;

var path = require('path');

var zserver_http = ZHttpServer.create();

zserver_http.initZookeeper({
...
zserver_http.registerService(serviceName, {
...
zserver_http.start('/testHttp', function(){
